...
\annote[Momo]{The PTS specifications for infrasonic frequency response sensor are $\pm 1\%$ on the amplitude gain and $\pm 5\degree$ on the phase in the frequency bandwidth going from $0.02$ Hz up to $4$ Hz}{pas d'accord}. That represents a challenging issue.\\*
