...
%================================
In this section we report analysis of the data from IS2. The numerical values are reported in figures from \ref{fig:C2} to \ref{fig:C8} associated with the sensors 2 to 8.
 ...
 \figscale{afewdaysonI26C7H7.pdf}{Couple H7C7}{fig:C7}{0.5}
