...
In this section we report analysis of the data from IS2. The numerical values are reported in figures from \ref{fig:C2} to \ref{fig:C8} associated with the sensors 1 to 8.
 ...
 \figscale{3monthsonIS26SUT1.pdf}{Couple H1C1}{fig:C1}{1}
 
 \figscale{3monthsonIS26SUT2.pdf}{Couple H2C2}{fig:C2}{1}
  
 \figscale{3monthsonIS26SUT3.pdf}{Couple H3C3}{fig:C3}{1}

 \figscale{3monthsonIS26SUT4.pdf}{Couple H4C4}{fig:C4}{1}

 \figscale{3monthsonIS26SUT5.pdf}{Couple H5C5}{fig:C5}{1}

 \figscale{3monthsonIS26SUT6.pdf}{Couple H6C6}{fig:C6}{1}

 \figscale{3monthsonIS26SUT7.pdf}{Couple H7C7}{fig:C7}{1}

 \figscale{3monthsonIS26SUT8.pdf}{Couple H8C8}{fig:C8}{1}
