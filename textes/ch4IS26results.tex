...
\figscale{figures/2daysonIS26SUT1year2015day154.pdf}{Sup ratio in dB given by the expression \eqref{eq:ratio-sup-bis-exact} for 2 successive days into the $P=6$ frequency bands.}{}{1}


%\newpage\clearpage
%\figscale{figures/2daysonIS26SUT1year2015day154aboveTH.pdf}{Sup ratio in dB given by the expression \eqref{eq:ratio-sup-bis-exact} for 2 successive days into the $P=6$ %frequency bands for MSC above the threshold.}{}{1}
