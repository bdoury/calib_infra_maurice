...
\figscale{figures/clickdetails1year2015day286aboveTH.pdf}{Two days data added in the protocol to obtain the figure \ref{fig:withoutproblemons1}. We observe large bursts that can be considered as outliers, as they appear hugely different of the observed values outside of the bursts.}{fig:clickdetails1year2015day286aboveTH}{1}
...
\newpage\clearpage
%================================
\subsection{Averaging on $15$ randomly selected pairs of days}
%================================

To avoid the problems (cited section \ref{ss:problems}) which appear very rarely, it is advised to use a trimmed mean on several pairs of days. Figure \ref{averagedon20days1} we present a draw of randomly chosen pairs of days and a simple mean 
and the mean excluding $30\%$ of the lowest and highest values.



\figscale{slidesITW2015/averagedon20days1.pdf}{Sup ratio given by the expression \eqref{eq:ratio-sup-bis-exact}. The gray dots report the ratios averaged on a pair of 2 consecutive days, the red  disks report the average on 10 pairs of days.}{averagedon20days1}{0.8}
