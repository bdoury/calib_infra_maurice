...
\input{textes/spectralanalysis.tex}
%===========================================

%%===========================================
%%===========================================
%\chapter{Simulation}
%\input{textes/simulation.tex}
%%===========================================
...
{\tiny \verbatiminput{\programs/2progsCIandOthers/estimHanalysis.m}}

  \newpage
  \section{Test of coherence}
{\tiny \verbatiminput{\programs/2progsCIandOthers/SigniLevelTestCoherence.m}}
 
 \newpage
 \section{Statistical distribution of the ratios}
{\tiny \verbatiminput{\programs/2progsCIandOthers/CIHestimate.m}}

 \newpage
  \section{Example of filter bank description}
{\tiny \verbatiminput{\programs/3FBestimatesonIS26/filtercharacteristics0.m}}
...
\subsection{Settings}
{\tiny \verbatiminput{\programsfullprocess settings.m}}

\subsection{Main program}
{\tiny \verbatiminput{\programsfullprocess pipeline.m}}

\subsection{Conversion to format {\tt .mat}}
{\tiny \verbatiminput{\programsfullprocess convertCSStomatlab.m}}

\subsection{Analysis function}
{\tiny \verbatiminput{\programsfullprocess analyzeSUT.m}}

%{\tiny \verbatiminput{\programsfullprocess displayafigure.m}}
...
{\tiny \verbatiminput{\programsfullprocess extractSensorRatio.m}}

{\tiny \verbatiminput{\programsfullprocess displaySensorRatio.m}}


%============================================ 
\chapter{Toolbox}
\section{Spectral analysis for SUT}
...
{\tiny \verbatiminput{\programsToolbox statsRatiosHbis.m}
...
%===========================================
%============================================ 
\chapter{Miscellaneous utilitaries}
\section{execGPARSE}
{\tiny \verbatiminput{../../../0progsextract/execGPARSE.m}}
\section{convertCSS2matlab}
{\tiny \verbatiminput{../../../0progsextract/convertCSS2matlab.m}}
