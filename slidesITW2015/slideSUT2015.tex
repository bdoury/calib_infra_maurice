...
\begin{itemize}
\item
The experimental results obtained averaging over 4 months fully validate the calibration method;
\item
The experimental results obtained by couples of 2 days show a permanence (without outliers) in full agreement with the PTS requirements;
%\item
