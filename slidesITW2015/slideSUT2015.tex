...
\begin{itemize}
\item
In relationship with the resolution but also with the lack of stationarity, we have considered a sequence of durations in decreasing order with the frequency followed a pre-filtering. %However we have noticed that the design is not critical.
...
\begin{itemize}
\item
The numerical experimental results obtained on a large campaign of measurements fully validate the calibration method;
\item
